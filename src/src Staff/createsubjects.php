...
<head>
  ...
  <meta name="description" content="WEBD-325-45 Project: Create Subjects" />
...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.php">Branding: Create Subjects</a><!--Future DB Content-->
    <!-- Sidebar Toggle-->
